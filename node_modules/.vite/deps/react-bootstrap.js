...
import {
  ...
  NavItem_default,
  Nav_default
} from "./chunk-NSHW7W76.js";
import {
  Anchor_default,
  NavLink_default,
  useCallbackRef
} from "./chunk-2ZZLG7UM.js";
import {
  useIsomorphicEffect_default,
  useMounted
} from "./chunk-DULIBFRB.js";
import {
  createWithBsPrefix
} from "./chunk-T6MA4CHL.js";
import "./chunk-6CI6ZZ5S.js";
import {
  TabContext_default
} from "./chunk-3OGGRUUV.js";
import {
...
var Modal = React26.forwardRef(({
  ...
  const renderBackdrop = (0, import_react11.useCallback)((backdropProps) => (0, import_jsx_runtime28.jsx)("div", {
    ...backdropProps,
...
var Overlay2 = React30.forwardRef(({
  children: overlay,
  transition = Fade_default,
  popperConfig = {},
  rootClose = false,
  ...
  return (0, import_jsx_runtime31.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React30.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper,
        hasDoneInitialMeasure,
        className: (0, import_classnames25.default)(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
function OverlayTrigger({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React31.Children.only(children).props : {};
  const attachRef = (r) => {
  ...
  return (0, import_jsx_runtime34.jsxs)(import_jsx_runtime33.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react16.cloneElement)(children, triggerProps), (0, import_jsx_runtime32.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var PageItem = React32.forwardRef(({
  active = false,
  disabled = false,
  className,
  style,
  ...
  return (0, import_jsx_runtime35.jsx)("li", {
    ref,
    style,
    className: (0, import_classnames26.default)(className, "page-item", {
      active,
      disabled
    }),
...
function createButton(name, defaultValue, label = name) {
  const Button = React32.forwardRef(({
    children,
    ...props
...
var Pagination = React33.forwardRef(({
  ...
  return (0, import_jsx_runtime37.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames27.default)(className, decoratedBsPrefix, size2 && `${decoratedBsPrefix}-${size2}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames28.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size2 && `${bsPrefix}-${size2}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React34.forwardRef((props, ref) => {
...
var Placeholder = React35.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime40.jsx)("div", {
    ...
    ...props,
    role: "progressbar",
    className: (0, import_classnames29.default)(className, `${bsPrefix}-bar`, {
      [`bg-${variant}`]: variant,
...
var Ratio = React37.forwardRef(({
  ...
  return (0, import_jsx_runtime41.jsx)("div", {
    ...
    className: (0, import_classnames30.default)(bsPrefix, className, !isCustomRatio && `${bsPrefix}-${aspectRatio}`),
    children: React37.Children.only(children)
  });
});
...
var Row = React38.forwardRef(({
  ...
  return (0, import_jsx_runtime42.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames31.default)(className, decoratedBsPrefix, ...classes)
  });
});
Row.displayName = "Row";
var Row_default = Row;
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime54.jsxs)(Tabs_default, {
    ...
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime53.jsx)(Nav_default, {
      ...controlledProps,
      role: "tablist",
      as: "ul",
      variant,
